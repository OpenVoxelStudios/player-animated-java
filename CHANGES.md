...
- Added support for applying player skins (refer to [README.md](./README.md) for usage infos):
    - `/function aj:<namespace>/set_skin {name: "string"}`
    - `/function aj:<namespace>/set_skin_slim {name: "string"}`
    - `/function aj:<namespace>/apply_skin`
    - `/function aj:<namespace>/apply_skin_slim`
